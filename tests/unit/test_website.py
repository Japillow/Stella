...
class TestAlerting(object):
    ...
    def test_alerting_wait_for_enough_data(self, mock):
        ...
        assert website.ping_stats_list[120].response_codes_dict == {999: TIMEFRAME_FOR_ALERTS - 1}
    ...
    def test_alerting_fire_alert(self, mock):
        ...
        for i in range(TIMEFRAME_FOR_ALERTS):
            website.ping_and_update_ping_stats()
            website.check_for_alert()
        assert website.ping_stats_list[120].response_codes_dict == {999: TIMEFRAME_FOR_ALERTS}
    ...
    def test_alerting_wait_for_threshold_before_recovering(self, mock):
        ...
        for i in range(SERVER_DOWNTIME + 2):
            website.ping_and_update_ping_stats()
            website.check_for_alert()
        assert website.ping_stats_list[120].response_codes_dict == {111: 1, 999: TIMEFRAME_FOR_ALERTS - 1}
